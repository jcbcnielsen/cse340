...
-- Assignment 2 Query 4: Update the GM Hummer description to say 'a huge interior'
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_id = 10;

-- Assignment 2 Query 6: Update images and thumbnails to be in the /images/vehicles/ directory
UPDATE public.inventory
